...
<script type="text/javascript">
	...
	function save() {
		...
		transaction({
			url : basePath + '/dictionary/modifytype',
			jsonSet : jsonSet,
			async : false,
		...
		<table class="singlepage_table">
			<tbody>
				...
				<tr style="display: none;">
					<td>
						<input type="text" id="dictionaryTypeId" value="${typeVo.dictionaryTypeId}" />
					</td>
				</tr>
				<tr>
					...
					<td class="singlepage_right">
						<input type="text" id="name" name="name" value="${typeVo.name}" />
					</td>
				</tr>
				<tr>
					<td class="singlepage_left">
					...
					<td class="singlepage_right">
						<textarea id="description" name="description" rows="5">${typeVo.description}</textarea>
					</td>
				</tr>
			</tbody>
			<tfoot>
